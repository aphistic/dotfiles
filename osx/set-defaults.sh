...
sudo scutil --set ComputerName $COMPHOST
sudo scutil --set HostName $COMPHOST
sudo scutil --set LocalHostName $COMPHOST
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string $COMPHOST
